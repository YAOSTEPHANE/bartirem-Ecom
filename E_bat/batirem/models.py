...
class Categories(models.Model):
    ...
    image = models.ImageField(upload_to="Product_Images/Categorie_Img")
...
class Filter_Price(models.Model):
    FILTER_PRICE = (
        ...
        ('500000 TO 1000000', '500000 TO 1000000'),
        ('1000000 TO 5000000', '1000000 TO 5000000'),
        ('5000000 TO 10000000', '5000000 TO 10000000'),
        ('10000000 TO 50000000', '10000000 TO 50000000'),
        ('50000000 TO 100000000', '50000000 TO 100000000'),
        ('100000000 TO 500000000', '100000000 TO 500000000'),
        ('500000000 TO 1000000000', '500000000 TO 1000000000'),
        ('1000000000 TO 5000000000', '1000000000 TO 5000000000'),
    )
...
class Product(models.Model):
    ...
    def save(self, *args, **kwargs):
        if self.unique_id is None and self.created_date and self.id:
            self.unique_id = self.created_date.strftime(
